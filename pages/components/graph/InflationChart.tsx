...
const InflationChart = () => {
  ...
  // Obtener los años únicos de las etiquetas
  const years = Array.from(new Set(labels.map((label) => label.split('-')[0])));
  ...
  return (
    <div className="bg-gray-900 text-white p-4 rounded-lg shadow-lg">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold">Inflación Mensual</h2>
        <select
      value={yearFilter}
